...
public:
	...
	/** Mouse cursor position in window coordinates (for FPS look). */
	virtual void cursorPosCallback(GLFWwindow *window, double xpos, double ypos) { (void)window; (void)xpos; (void)ypos; }

	/** Scroll wheel (optional: adjust move speed). */
	virtual void scrollCallback(GLFWwindow *window, double xoffset, double yoffset) { (void)window; (void)xoffset; (void)yoffset; }
